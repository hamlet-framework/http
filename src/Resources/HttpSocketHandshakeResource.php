...
use Hamlet\Http\Responses\BadRequestResponse;
use Hamlet\Http\Responses\Response;
use Hamlet\Http\Responses\WebSocketUpgradeResponse;

/**
 * WebSocket handshake resource
 * https://developer.mozilla.org/en-US/docs/Web/HTTP/Protocol_upgrade_mechanism
 */
class HttpSocketHandshakeResource implements HttpResource
{
